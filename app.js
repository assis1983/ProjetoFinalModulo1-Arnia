...
const emailPaciente = document.querySelector('#inputEmailpaciente')
...
window.addEventListener('DOMContentLoaded', async (e) => {
  ...
  coleta_Dados.map((element) => { 
    ...
    <th scope="col" class="border border-3 text-center"><a href="#" data-bs-toggle="modal" data-bs-target="#visualizarDados" class="text-muted data-toggle="tooltip" data-placement="right" title="Visualizar Dados" style="text-decoration: none;" onclick="visualizarInfo(${element.id})">${element.name}</a></th>
    <th scope="col" class="border border-3 text-center"><a href="#" data-bs-toggle="modal" data-bs-target="#visualizarDados" class="text-muted data-toggle="tooltip" data-placement="right" title="Visualizar Dados" style="text-decoration: none;" onclick="visualizarInfo(${element.id})">${element.cpf}</a></th>
